...
import { BiodiversityData, RoleName } from "@/types/common.types";
...
import UpdateBiodiversityDataForm from "./UpdateBiodiversityDataForm";

interface BiodiversityDataTableRowProps {
...
const BiodiversityDataTableRow: React.FC<BiodiversityDataTableRowProps> = ({
  ...
  const deleteBiodiversityDataMutation = useMutation({
    mutationFn: async (biodiversityDataId: string) => {
    ...
    onError: (error: any) => {
      toast.error("Couldn't delete biodiversity data.");
    },
  });

  const handleDelete = () => {
    deleteBiodiversityDataMutation.mutate(data.biodiversityDataId);
  };
  ...
  return (
    <>
      <TableRow>
        ...
        <TableCell>{data.speciesCount ?? "N/A"}</TableCell>
        <TableCell>{data.shannonIndex ?? "N/A"}</TableCell>
        {/* <TableCell>{data.observations ? JSON.stringify(data.observations) : "N/A"}</TableCell> */}
        <TableCell>
...
export default BiodiversityDataTableRow;
