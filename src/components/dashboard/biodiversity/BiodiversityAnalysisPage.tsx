...
import { BiodiversityData, Location, LocationType } from "@/types/common.types";
...
export default function BiodiversityAnalysisPage() {
  ...
  }, [biodiversityData, timePeriods, groupedData, locations, selectedParameter, chartType]);

  // Prepare data for bar chart
  const barChartData = useMemo(() => {
    if (!biodiversityData || !timePeriods.length || !locationIdsFilter.length) return [];
  ...
  }, [biodiversityData, timePeriods, groupedData, locations, selectedParameter, chartType, locationIdsFilter]);
            ...
            <div className="w-full ">
               <label className="block text-sm font-medium mb-2">Paramter Selection</label>
                <Select
                  ...
                  onValueChange={(value) => setSelectedParameter(value as keyof BiodiversityData)}
                >
