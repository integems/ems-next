...
export default function BiodiversityAnalysisPage() {
  ...
  const [selectedParameter2, setSelectedParameter2] =
    useState<keyof BiodiversityData>("shannonIndex");
  ...
  }, [biodiversityData, selectedParameter, selectedParameter2]);
              ...
              <div>
                ...
                <CardContent>
                  <Select
                    ...
                    onValueChange={(value) =>
                      setSelectedParameter2(value as keyof BiodiversityData)
                    }
                  >
                    <SelectTrigger className="bg-background border-border">
