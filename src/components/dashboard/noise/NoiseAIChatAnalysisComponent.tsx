...
export default function NoiseAIChatAnalysis({
  ...
  const [selectedParameter, setSelectedParameter] =
    useState<keyof NoiseData>("avgLevel");
  const [chartType, setChartType] = useState<"monthly" | "daily" | "quarterly">(
    "monthly",
  );
  const [isMapOpen, setIsMapOpen] = useState(false);

  // Extract unique locations from noiseData
  ...
  const parameterOptions: { value: keyof NoiseData; label: string }[] = [
    { value: "avgLevel", label: "Average Level (dB)" },
    { value: "minLevel", label: "Min Level (dB)" },
    { value: "maxLevel", label: "Max Level (dB)" },
  ];
      ...
      <div className="py-8 space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg">
            Data analysis and visualization of selected noise level measurements
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 max-w-sm">
            ...
            <Select
              ...
              onValueChange={(value: keyof NoiseData) =>
