...
import { WaterData, TimeOfDay, LocationType, WaterSource } from "@/types/common.types";
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <div className="space-y-2">
            ...
            <Input type="number" name="ph" value={formData.ph as number || 0} onChange={handleChange} placeholder="0" />
          ...
          <div className="space-y-2">
            ...
            <Input type="number" name="phMv" value={formData.phMv as number || 0} onChange={handleChange} placeholder="0" />
            {errors.phMv && <p className="text-xs text-red-500">{Array.isArray(errors.phMv) ? errors.phMv[0] : errors.phMv}</p>}
          </div>
          <div className="space-y-2">
            <Label className="text-sm">ORP (mV)</Label>
            <Input type="number" name="orp" value={formData.orp as number || 0} onChange={handleChange} placeholder="0" />
            {errors.orp && <p className="text-xs text-red-500">{Array.isArray(errors.orp) ? errors.orp[0] : errors.orp}</p>}
          </div>
          
          <div className="space-y-2">
            <Label className="text-sm">EC (µS/cm)</Label>
            <Input type="number" name="ec" value={formData.ec as number || 0} onChange={handleChange} placeholder="0" />
            {errors.ec && <p className="text-xs text-red-500">{Array.isArray(errors.ec) ? errors.ec[0] : errors.ec}</p>}
          </div>
          <div className="space-y-2">
            <Label className="text-sm">EC Abs. (µS/cm)</Label>
            <Input type="number" name="ecAbs" value={formData.ecAbs as number || 0} onChange={handleChange} placeholder="0" />
            {errors.ecAbs && <p className="text-xs text-red-500">{Array.isArray(errors.ecAbs) ? errors.ecAbs[0] : errors.ecAbs}</p>}
          </div>
          <div className="space-y-2">
            <Label className="text-sm">Resistivity (Ohm-cm)</Label>
            <Input type="number" name="resistivity" value={formData.resistivity as number || 0} onChange={handleChange} placeholder="0" />
            {errors.resistivity && <p className="text-xs text-red-500">{Array.isArray(errors.resistivity) ? errors.resistivity[0] : errors.resistivity}</p>}
          </div>
          <div className="space-y-2">
            <Label className="text-sm">Salinity (psu)</Label>
            <Input type="number" name="salinity" value={formData.salinity as number || 0} onChange={handleChange} placeholder="0" />
            {errors.salinity && <p className="text-xs text-red-500">{Array.isArray(errors.salinity) ? errors.salinity[0] : errors.salinity}</p>}
          </div>
          <div className="space-y-2">
            <Label className="text-sm">Pressure (psi)</Label>
            <Input type="number" name="pressure" value={formData.pressure as number || 0} onChange={handleChange} placeholder="0" />
            {errors.pressure && <p className="text-xs text-red-500">{Array.isArray(errors.pressure) ? errors.pressure[0] : errors.pressure}</p>}
          </div>
          <div className="space-y-2">
            <Label className="text-sm">D.O. (%)</Label>
            <Input type="number" name="doPercent" value={formData.doPercent as number || 0} onChange={handleChange} placeholder="0" />
            {errors.doPercent && <p className="text-xs text-red-500">{Array.isArray(errors.doPercent) ? errors.doPercent[0] : errors.doPercent}</p>}
          </div>
          <div className="space-y-2">
            <Label className="text-sm">D.O. (ppm)</Label>
            <Input type="number" name="dissolvedOxygen" value={formData.dissolvedOxygen as number || 0} onChange={handleChange} placeholder="0" />
          ...
          <div className="space-y-2">
            ...
            <Input type="number" name="turbidity" value={formData.turbidity as number || 0} onChange={handleChange} placeholder="0" />
          ...
          <div className="space-y-2">
            ...
            <Input type="number" name="bod" value={formData.bod as number || 0} onChange={handleChange} placeholder="0" />
          ...
          <div className="space-y-2">
            ...
            <Input type="number" name="cod" value={formData.cod as number || 0} onChange={handleChange} placeholder="0" />
          ...
          <div className="space-y-2">
            ...
            <Input type="number" name="totalDissolvedSolids" value={formData.totalDissolvedSolids as number || 0} onChange={handleChange} placeholder="0" />
          ...
          <div className="space-y-2">
            ...
            <Input type="number" name="temperature" value={formData.temperature as number || 0} onChange={handleChange} placeholder="0" />
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value: WaterSource) => setFormData((prev) => ({ ...prev, waterSource: value }))}
            >
              <SelectTrigger>
            ...
            {errors.waterSource && <p className="text-xs text-red-500">{Array.isArray(errors.waterSource) ? errors.waterSource[0] : errors.waterSource}</p>}
          </div>
          <div className="space-y-2">
