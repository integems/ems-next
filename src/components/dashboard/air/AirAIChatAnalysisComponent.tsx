...
import { AirData, Location } from "@/types/common.types";
...
export default function AirAIChatAnalysis({ airData }: AirAIChatAnalysisProps) {
  ...
  // Extract unique locations from airData
      ...
      <div className="py-8 space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg">
            Data analysis and visualization of selected air quality measurements
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 max-w-sm">
            ...
            <Select
              ...
              onValueChange={(value: keyof AirData) =>
