...
export default function WasteAIChatAnalysis({
  ...
  const [selectedParameter, setSelectedParameter] =
    useState<keyof WasteData>("weight");
  const [chartType, setChartType] = useState<"monthly" | "daily" | "quarterly">(
    "monthly",
  );
  const [isMapOpen, setIsMapOpen] = useState(false);

  // Extract unique locations from wasteData
  ...
  const parameterOptions: { value: keyof WasteData; label: string }[] = [
    ...
    { value: "recyclingRate", label: "Recycling Rate (%)" },
  ];
      ...
      <div className="py-8 space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-600 dark:text-slate-400 text-lg">
            Data analysis and visualization of selected waste management
            measurements
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="flex-1 max-w-sm">
            ...
            <Select
              ...
              onValueChange={(value: keyof WasteData) =>
